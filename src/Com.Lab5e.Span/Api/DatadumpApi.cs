...
namespace Com.Lab5e.Span.Api
{
    ...
    public interface IDatadumpApiSync : IApiAccessor
    {
        ...
        ApiResponse<DataDumpResponse> SpanDataDumpWithHttpInfo(Object body);
    ...
    public interface IDatadumpApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DataDumpResponse> SpanDataDumpAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DataDumpResponse>> SpanDataDumpWithHttpInfoAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class DatadumpApi : IDatadumpApi
    {
        ...
        /// <param name="body"></param>
        /// <returns>DataDumpResponse</returns>
        public DataDumpResponse SpanDataDump(Object body)
        {
            Com.Lab5e.Span.Client.ApiResponse<DataDumpResponse> localVarResponse = SpanDataDumpWithHttpInfo(body);
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of DataDumpResponse</returns>
        public Com.Lab5e.Span.Client.ApiResponse<DataDumpResponse> SpanDataDumpWithHttpInfo(Object body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Com.Lab5e.Span.Client.ApiException(400, "Missing required parameter 'body' when calling DatadumpApi->SpanDataDump");
            ...
            {
                Exception _exception = this.ExceptionFactory("SpanDataDump", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DataDumpResponse</returns>
        public async System.Threading.Tasks.Task<DataDumpResponse> SpanDataDumpAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Lab5e.Span.Client.ApiResponse<DataDumpResponse> localVarResponse = await SpanDataDumpWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DataDumpResponse)</returns>
        public async System.Threading.Tasks.Task<Com.Lab5e.Span.Client.ApiResponse<DataDumpResponse>> SpanDataDumpWithHttpInfoAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Com.Lab5e.Span.Client.ApiException(400, "Missing required parameter 'body' when calling DatadumpApi->SpanDataDump");
