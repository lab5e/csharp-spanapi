...
namespace Com.Lab5e.Span.Api
{
    ...
    public interface IFotaApiSync : IApiAccessor
    {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Firmware</returns>
        ApiResponse<Firmware> UpdateFirmwareWithHttpInfo(string collectionId, string imageId, Firmware body);
    ...
    public interface IFotaApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Firmware</returns>
        System.Threading.Tasks.Task<Firmware> UpdateFirmwareAsync(string collectionId, string imageId, Firmware body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Firmware)</returns>
        System.Threading.Tasks.Task<ApiResponse<Firmware>> UpdateFirmwareWithHttpInfoAsync(string collectionId, string imageId, Firmware body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class FotaApi : IFotaApi
    {
        ...
        public Com.Lab5e.Span.Client.ApiResponse<ClearFirmwareErrorResponse> ClearFirmwareErrorWithHttpInfo(string collectionId, string deviceId)
        {
            ...
            var localVarResponse = this.Client.Delete<ClearFirmwareErrorResponse>("/collections/{collectionId}/devices/{deviceId}/fwerror", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Com.Lab5e.Span.Client.ApiResponse<ClearFirmwareErrorResponse>> ClearFirmwareErrorWithHttpInfoAsync(string collectionId, string deviceId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<ClearFirmwareErrorResponse>("/collections/{collectionId}/devices/{deviceId}/fwerror", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Com.Lab5e.Span.Client.ApiResponse<FirmwareUsageResponse> FirmwareUsageWithHttpInfo(string collectionId, string imageId)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FirmwareUsageResponse>("/collections/{collectionId}/firmware/{imageId}/usage", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Com.Lab5e.Span.Client.ApiResponse<FirmwareUsageResponse>> FirmwareUsageWithHttpInfoAsync(string collectionId, string imageId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FirmwareUsageResponse>("/collections/{collectionId}/firmware/{imageId}/usage", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="body"></param>
        /// <returns>Firmware</returns>
        public Firmware UpdateFirmware(string collectionId, string imageId, Firmware body)
        {
            Com.Lab5e.Span.Client.ApiResponse<Firmware> localVarResponse = UpdateFirmwareWithHttpInfo(collectionId, imageId, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Firmware</returns>
        public Com.Lab5e.Span.Client.ApiResponse<Firmware> UpdateFirmwareWithHttpInfo(string collectionId, string imageId, Firmware body)
        {
            // verify the required parameter 'collectionId' is set
            if (collectionId == null)
                throw new Com.Lab5e.Span.Client.ApiException(400, "Missing required parameter 'collectionId' when calling FotaApi->UpdateFirmware");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Firmware</returns>
        public async System.Threading.Tasks.Task<Firmware> UpdateFirmwareAsync(string collectionId, string imageId, Firmware body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Lab5e.Span.Client.ApiResponse<Firmware> localVarResponse = await UpdateFirmwareWithHttpInfoAsync(collectionId, imageId, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Firmware)</returns>
        public async System.Threading.Tasks.Task<Com.Lab5e.Span.Client.ApiResponse<Firmware>> UpdateFirmwareWithHttpInfoAsync(string collectionId, string imageId, Firmware body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'collectionId' is set
            if (collectionId == null)
                throw new Com.Lab5e.Span.Client.ApiException(400, "Missing required parameter 'collectionId' when calling FotaApi->UpdateFirmware");
