...
namespace Com.Lab5e.Span.Api
{
    ...
    public interface IFotaApiSync : IApiAccessor
    {
        ...
        /// <param name="imageRefImageRef"> (optional)</param>
        /// <param name="imageRefCreatedAt"> (optional)</param>
        /// <param name="imageRefFileName"> (optional)</param>
        /// <param name="imageRefLength"> (optional)</param>
        /// <param name="imageRefChecksum"> (optional)</param>
        /// <param name="imageRefSha256"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CreateLabeledFirmwareResponse</returns>
        CreateLabeledFirmwareResponse CreateLabeledFirmware(string collectionId, string? version = default(string?), string? label = default(string?), string? imageRefImageRef = default(string?), string? imageRefCreatedAt = default(string?), string? imageRefFileName = default(string?), string? imageRefLength = default(string?), string? imageRefChecksum = default(string?), string? imageRefSha256 = default(string?), int operationIndex = 0);
        ...
        ApiResponse<CreateLabeledFirmwareResponse> CreateLabeledFirmwareWithHttpInfo(string collectionId, string? version = default(string?), string? label = default(string?), string? imageRefImageRef = default(string?), string? imageRefCreatedAt = default(string?), string? imageRefFileName = default(string?), string? imageRefLength = default(string?), string? imageRefChecksum = default(string?), string? imageRefSha256 = default(string?), int operationIndex = 0);
        /// <summary>
        /// Delete firmware
        /// </summary>
        /// <exception cref="Com.Lab5e.Span.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IFotaApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreateLabeledFirmwareResponse> CreateLabeledFirmwareAsync(string collectionId, string? version = default(string?), string? label = default(string?), string? imageRefImageRef = default(string?), string? imageRefCreatedAt = default(string?), string? imageRefFileName = default(string?), string? imageRefLength = default(string?), string? imageRefChecksum = default(string?), string? imageRefSha256 = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class FotaApi : IFotaApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CreateLabeledFirmwareResponse</returns>
        public CreateLabeledFirmwareResponse CreateLabeledFirmware(string collectionId, string? version = default(string?), string? label = default(string?), string? imageRefImageRef = default(string?), string? imageRefCreatedAt = default(string?), string? imageRefFileName = default(string?), string? imageRefLength = default(string?), string? imageRefChecksum = default(string?), string? imageRefSha256 = default(string?), int operationIndex = 0)
        {
            Com.Lab5e.Span.Client.ApiResponse<CreateLabeledFirmwareResponse> localVarResponse = CreateLabeledFirmwareWithHttpInfo(collectionId, version, label, imageRefImageRef, imageRefCreatedAt, imageRefFileName, imageRefLength, imageRefChecksum, imageRefSha256);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateLabeledFirmwareResponse</returns>
        public Com.Lab5e.Span.Client.ApiResponse<CreateLabeledFirmwareResponse> CreateLabeledFirmwareWithHttpInfo(string collectionId, string? version = default(string?), string? label = default(string?), string? imageRefImageRef = default(string?), string? imageRefCreatedAt = default(string?), string? imageRefFileName = default(string?), string? imageRefLength = default(string?), string? imageRefChecksum = default(string?), string? imageRefSha256 = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'collectionId' is set
            if (collectionId == null)
            {
            ...
            if (imageRefImageRef != null)
            {
                localVarRequestOptions.QueryParameters.Add(Com.Lab5e.Span.Client.ClientUtils.ParameterToMultiMap("", "imageRef.imageRef", imageRefImageRef));
            }
            if (imageRefCreatedAt != null)
            {
                localVarRequestOptions.QueryParameters.Add(Com.Lab5e.Span.Client.ClientUtils.ParameterToMultiMap("", "imageRef.createdAt", imageRefCreatedAt));
            }
            if (imageRefFileName != null)
            {
                localVarRequestOptions.QueryParameters.Add(Com.Lab5e.Span.Client.ClientUtils.ParameterToMultiMap("", "imageRef.fileName", imageRefFileName));
            }
            if (imageRefLength != null)
            {
                localVarRequestOptions.QueryParameters.Add(Com.Lab5e.Span.Client.ClientUtils.ParameterToMultiMap("", "imageRef.length", imageRefLength));
            }
            if (imageRefChecksum != null)
            {
                localVarRequestOptions.QueryParameters.Add(Com.Lab5e.Span.Client.ClientUtils.ParameterToMultiMap("", "imageRef.checksum", imageRefChecksum));
            }
            if (imageRefSha256 != null)
            {
                localVarRequestOptions.QueryParameters.Add(Com.Lab5e.Span.Client.ClientUtils.ParameterToMultiMap("", "imageRef.sha256", imageRefSha256));
            }
        ...
        {
            Com.Lab5e.Span.Client.ApiResponse<CreateLabeledFirmwareResponse> localVarResponse = await CreateLabeledFirmwareWithHttpInfoAsync(collectionId, version, label, imageRefImageRef, imageRefCreatedAt, imageRefFileName, imageRefLength, imageRefChecksum, imageRefSha256, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
