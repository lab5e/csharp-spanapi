...
namespace Com.Lab5e.Span.Api
{
    ...
    public interface ISystemApiSync : IApiAccessor
    {
        ...
        ApiResponse<SystemInfoResponse> SpanGetSystemInfoWithHttpInfo();
    ...
    public interface ISystemApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SystemInfoResponse> SpanGetSystemInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SystemInfoResponse>> SpanGetSystemInfoWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SystemApi : ISystemApi
    {
        ...
        /// <exception cref="Com.Lab5e.Span.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>SystemInfoResponse</returns>
        public SystemInfoResponse SpanGetSystemInfo()
        {
            Com.Lab5e.Span.Client.ApiResponse<SystemInfoResponse> localVarResponse = SpanGetSystemInfoWithHttpInfo();
        ...
        /// <exception cref="Com.Lab5e.Span.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of SystemInfoResponse</returns>
        public Com.Lab5e.Span.Client.ApiResponse<SystemInfoResponse> SpanGetSystemInfoWithHttpInfo()
        {
            ...
            {
                Exception _exception = this.ExceptionFactory("SpanGetSystemInfo", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SystemInfoResponse</returns>
        public async System.Threading.Tasks.Task<SystemInfoResponse> SpanGetSystemInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Lab5e.Span.Client.ApiResponse<SystemInfoResponse> localVarResponse = await SpanGetSystemInfoWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SystemInfoResponse)</returns>
        public async System.Threading.Tasks.Task<Com.Lab5e.Span.Client.ApiResponse<SystemInfoResponse>> SpanGetSystemInfoWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
