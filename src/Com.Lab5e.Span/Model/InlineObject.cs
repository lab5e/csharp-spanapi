...
namespace Com.Lab5e.Span.Model
{
    ...
    public partial class InlineObject : IEquatable<InlineObject>, IValidatableObject
    {
        ...
        public InlineObject(string name = default(string), GatewayType? type = default(GatewayType?), GatewayConfig config = default(GatewayConfig), Dictionary<string, string> tags = default(Dictionary<string, string>))
        {
            this.Name = name;
            this.Type = type;
            this.Config = config;
