...
namespace Com.Lab5e.Span.Model
{
    ...
    public partial class DeviceStats : IEquatable<DeviceStats>, IValidatableObject
    {
        ...
        public DeviceStats(string bytesUpstream = default(string), string bytesDownstream = default(string), string messagesUpstream = default(string), string messagesDownstream = default(string), int sessionCount = default(int))
        {
