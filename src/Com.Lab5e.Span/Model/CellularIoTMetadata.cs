...
namespace Com.Lab5e.Span.Model
{
    ...
    public partial class CellularIoTMetadata : IEquatable<CellularIoTMetadata>, IValidatableObject
    {
        ...
        /// <param name="lastImsi">lastImsi.</param>
        /// <param name="lastImei">lastImei.</param>
        public CellularIoTMetadata(string gatewayId = default(string), string allocatedIp = default(string), string allocatedAt = default(string), string cellId = default(string), int mcc = default(int), int mnc = default(int), string country = default(string), string network = default(string), string countryCode = default(string), string lastUpdate = default(string), string lastImsi = default(string), string lastImei = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets LastImsi
        /// </summary>
        [DataMember(Name = "lastImsi", EmitDefaultValue = false)]
        public string LastImsi { get; set; }

        /// <summary>
        /// Gets or Sets LastImei
        /// </summary>
        [DataMember(Name = "lastImei", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LastImsi: ").Append(LastImsi).Append("\n");
            sb.Append("  LastImei: ").Append(LastImei).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(CellularIoTMetadata input)
        {
            ...
            return 
                ...
                (
                    this.LastImsi == input.LastImsi ||
                    (this.LastImsi != null &&
                    this.LastImsi.Equals(input.LastImsi))
                ) && 
                (
                    this.LastImei == input.LastImei ||
                    (this.LastImei != null &&
                    this.LastImei.Equals(input.LastImei))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.LastImsi.GetHashCode();
                }
                if (this.LastImei != null)
                {
                    hashCode = (hashCode * 59) + this.LastImei.GetHashCode();
                }
                return hashCode;
            }
        }
