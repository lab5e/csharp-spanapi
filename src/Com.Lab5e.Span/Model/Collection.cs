...
namespace Com.Lab5e.Span.Model
{
    ...
    public partial class Collection : IEquatable<Collection>, IValidatableObject
    {
        ...
        public Collection(string collectionId = default(string), string teamId = default(string), CollectionFirmware firmware = default(CollectionFirmware), Dictionary<string, string> tags = default(Dictionary<string, string>))
        {
