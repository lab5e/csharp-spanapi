...
namespace Com.Lab5e.Span.Model
{
    ...
    public partial class DeviceMetadata : IEquatable<DeviceMetadata>, IValidatableObject
    {
        ...
        public DeviceMetadata(NetworkOperator simOperator = default(NetworkOperator), CellularIoTMetadata ciot = default(CellularIoTMetadata), InetMetadata inet = default(InetMetadata), GatewayDeviceMetadata gateway = default(GatewayDeviceMetadata))
        {
