...
namespace Com.Lab5e.Span.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCertificateResponse")]
    public partial class CreateCertificateResponse : IEquatable<CreateCertificateResponse>, IValidatableObject
    {
        ...
        public CreateCertificateResponse(byte[] certificate = default(byte[]), byte[] privateKey = default(byte[]), byte[] chain = default(byte[]))
        {
        ...
        /// </summary>
        /// <param name="input">Instance of CreateCertificateResponse to be compared</param>
        /// <returns>Boolean</returns>
