...
namespace Com.Lab5e.Span.Model
{
    ...
    public partial class Device : IEquatable<Device>, IValidatableObject
    {
        ...
        public Device(string deviceId = default(string), string collectionId = default(string), Dictionary<string, string> tags = default(Dictionary<string, string>), FirmwareMetadata firmware = default(FirmwareMetadata), DeviceConfig config = default(DeviceConfig), DeviceMetadata metadata = default(DeviceMetadata), string lastGatewayId = default(string), MessageTransport? lastTransport = default(MessageTransport?), string lastReceived = default(string), byte[] lastPayload = default(byte[]))
        {
