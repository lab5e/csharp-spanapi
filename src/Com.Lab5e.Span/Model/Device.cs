...
namespace Com.Lab5e.Span.Model
{
    ...
    public partial class Device : IEquatable<Device>, IValidatableObject
    {
        ...
        public Device(string deviceId = default(string), string collectionId = default(string), string imsi = default(string), string imei = default(string), Dictionary<string, string> tags = default(Dictionary<string, string>), NetworkMetadata network = default(NetworkMetadata), FirmwareMetadata firmware = default(FirmwareMetadata), DeviceMetadata metadata = default(DeviceMetadata))
        {
