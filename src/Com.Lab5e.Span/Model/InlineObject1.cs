...
namespace Com.Lab5e.Span.Model
{
    ...
    public partial class InlineObject1 : IEquatable<InlineObject1>, IValidatableObject
    {
        ...
        public InlineObject1(string name = default(string), string collectionId = default(string), GatewayType? type = default(GatewayType?), GatewayConfig config = default(GatewayConfig), Dictionary<string, string> tags = default(Dictionary<string, string>))
        {
            this.Name = name;
